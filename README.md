...
## Introduction
Google Translate is command line utility used for translation of Google DialogFlow agents. Ambition of this tool is to replace original Agent Toolkit that can (among things translate GDF agents). The advantages of this new tool (over agent toolkit) are following:
