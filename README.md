...
* 	Support for glossaries. Starting from version v0.1.4-beta we are supporting translation glossaries (mapping files telling how exactly to translate particular phrases) for V3 API!. Simply create TSV file and use *--glossary* switch. More details [here](https://cloud.google.com/translate/docs/advanced/glossary).
